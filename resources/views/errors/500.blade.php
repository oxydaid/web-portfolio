...
<body class="bg-dark-950 text-slate-300 font-sans antialiased selection:bg-primary selection:text-black relative">
    ...
    <div class="min-h-screen flex items-center justify-center relative overflow-hidden pt-20 pb-20">
        ...
        <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-150 h-150 bg-red-600/10 rounded-full blur-[150px] -z-10 animate-pulse"></div>

        <div class="text-center px-4 relative z-10 max-w-2xl mx-auto">
            
            <!-- Icon -->
            <div class="mb-8 inline-block relative">
                <i class="fa-solid fa-biohazard text-8xl text-red-600 animate-pulse"></i>
            ...
            <h1 class="text-8xl md:text-9xl font-display font-bold text-white mb-2 tracking-tighter relative inline-block">
                500
                <span class="absolute top-0 left-0 -ml-1 text-red-600 opacity-70 animate-ping">500</span>
            </h1>

            <h2 class="text-2xl md:text-3xl font-display font-bold text-red-500 tracking-widest mb-6 uppercase">
            ...
            <div class="bg-dark-900/80 border border-red-500/30 p-6 clip-cut-corner mb-10 text-left relative">
                ...
                <p class="font-mono text-sm text-slate-400 mb-2">
                    <span class="text-red-500">> ERROR_CODE:</span> CRITICAL_CORE_FAILURE
                </p>
                <p class="font-mono text-sm text-slate-400 mb-2">
                    <span class="text-red-500">> DIAGNOSTIC:</span> Unexpected condition encountered. The server cannot fulfill the request.
                </p>
                <p class="font-mono text-sm text-slate-400 animate-pulse">
                    <span class="text-red-500">> ACTION:</span> CONTACT_ADMINISTRATOR
                </p>
            </div>
